...
#### Possible uses: 
  * **`triangle`** (`float`) --->  `geomet ry`
  * `float` **`triangle`** `float` --->  `geomet ry`
  * **`triangle`** (`float` , `float`) --->  `geomet ry` 
...
**See also:** [around](#around), [circle](#circle), [cone](#cone), [line](#line), [link](#link), [norm](#norm), [point](#point), [polygon](#polygon), [polyline](#polyline), [rectangle](#rectangle), [square](OperatorsSZ#square)
...
#### Possible uses: 
  * **`triangulate`** (`geomet ry`) --->  `list<geometry>`
  * **`triangulate`** (`list<geometry>`) --->  `list<geometry>`
  * `geomet ry` **`triangulate`** `float` --->  `list<geometry>`
  * **`triangulate`** (`geomet ry` , `float`) --->  `list<geometry>`
  * **`triangulate`** (`geomet ry`, `float`, `float`) --->  `list<geometry>`
  * **`triangulate`** (`geomet ry`, `float`, `float`, `bool`) --->  `list<geometry>` 
...
**See also:** [binomial](#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](#lognormal_rnd), [poisson](#poisson), [rnd](#rnd), [skew_gauss](OperatorsSZ#skew_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), [gamma_trunc_rnd](OperatorsDH#gamma_trunc_rnd), [weibull_trunc_rnd](OperatorsSZ#weibull_trunc_rnd), [lognormal_trunc_rnd](#lognormal_trunc_rnd)
...
**See also:** [directed](OperatorsDH#directed)
...
#### Possible uses: 
  * **`union`** (`container<unknown,geometry>`) --->  `geomet ry`
...
**See also:** [lower_case](#lower_case)
...
#### Possible uses: 
  * `field` **`values_in`** `geomet ry` --->  `list<float>`
  * **`values_in`** (`field` , `geomet ry`) --->  `list<float>`
...
int var2 <- int(variance(4,16,84)); // var2 equals 5
```
...
**See also:** [min_of](#min_of), [max_of](#max_of), [sum_of](OperatorsSZ#sum_of), [product_of](#product_of)
...
#### Possible uses: 
  ...
  * `list<point>` **`voronoi`** `geomet ry` --->  `list<geometry>`
  * **`voronoi`** (`list<point>` , `geomet ry`) --->  `list<geometry>` 
...
**See also:** [weibull_rnd](OperatorsSZ#weibull_rnd), [gamma_trunc_rnd](OperatorsDH#gamma_trunc_rnd), [lognormal_trunc_rnd](#lognormal_trunc_rnd), [truncated_gauss](OperatorsSZ#truncated_gauss)
...
**See also:** [first_with](OperatorsDH#first_with), [last_with](#last_with)
...
**See also:** [where](OperatorsSZ#where), [with_min_of](OperatorsSZ#with_min_of)
...
**See also:** [where](OperatorsSZ#where), [with_max_of](OperatorsSZ#with_max_of)
...
#### Possible uses: 
  ...
  * `geomet ry` **`with_precision`** `int` --->  `geomet ry`
  * **`with_precision`** (`geomet ry` , `int`) --->  `geomet ry`
...
#### Possible uses: 
  * **`without_holes`** (`geomet ry`) --->  `geomet ry` 
...
**See also:** [file](OperatorsDH#file)
